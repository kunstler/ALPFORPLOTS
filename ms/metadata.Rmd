...
Archives analysis, using maps from the beginning of the 19^th^ century and aerial photographs of the middle of the 20^th^ century, have attested that French Alps forests are dominated by uneven-aged ancient forests that have been continuously forested for more than 200 years [@Janssen-2016]. Most of the plots are established in such forests. In contrast, some plots are established in stands that originate either from colonization of abandoned agricultural lands or from man-made rehabilitation of degraded lands at the end of the 19th century and now consist in quite even-aged stands 120–180 years old. 

Dominant management system in the French Alps forests is uneven-aged management and consists in single-tree or small-group selection cutting. Moreover, harvesting rate has been very low for the last 150 years, because the protection function of the forest was crucial and because of the decrease in wood price. In comparison with other European forests, forests in this area are thus generally richer in large and old trees and in deadwood and stand structure is rather heterogeneous [@Paillet-2015]. Consequently, they are considered as biodiversity hotspots [@EEA-2010; @Barbati-2014] of high protection, conservation, and economical values. 
...
mapplots(data_p)
```
**Figure 1** Plots distribution in France. Plots near from one another are represented by the same point.
...
Plots were installed from 1994 to 2004 and measured 2 to 5 times during the 1994-2015 period. Plot sizes range from to 0.25 ha to 1.88 ha. At the establishment of the plots, plot densities ranges from 182 to 1328 stems.ha^-1^ and plot basal areas ranges from `r min(table_stand$ba_init, na.rm = TRUE)` to `r max(table_stand$ba_init, na.rm = TRUE)` m^2^.ha^-1^ (Table. 2).
