...
**1. Storage location and medium**: The data are stored in the attached file alpforplots.zip (output directory). Updated versions of the data will be available at https://forge.irstea.fr/projects/alpforplots 
