...
**Latest update**: The dataset made available through this publication was processed on 27/07/2016. R code use to check the data can be retrieved from the following website [github.com/kunstler/AlpineForestData](https://github.com/kunstler/AlpineForestData).
